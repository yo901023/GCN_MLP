...
def main():
    ...
    output_dir = "/media/main/HDD/yo/GraphMLP-main/output_ViTPose_test_Env5"
    os.makedirs(output_dir, exist_ok=True)
    
    csi_root = "/media/main/HDD/yo/dataset/Env5_test/npy_dwt"
    img_root = "/media/main/HDD/yo/dataset/Env5_test/img_nomask"
    gt_root  = "/media/main/HDD/yo/dataset/Env5_test/kpt_npz_vitpose"
