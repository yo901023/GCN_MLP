...
def main():
    ...
    checkpoint = torch.load('/media/main/HDD/yo/GraphMLP-main/checkpoint/1029_1059_18_1/model_35_3752.pth')
    model.load_state_dict(checkpoint)
    model.eval()

    output_dir = "/media/main/HDD/yo/GraphMLP-main/output_ViTPose_test12"
    ...
    for idx, csi_path in enumerate(tqdm(sampled_files, desc="🔍 推論中")):
        ...
        csi_input = torch.tensor(mag).unsqueeze(0).cuda()
