...
def main():
    ...
    checkpoint = torch.load('/media/main/HDD/yo/GraphMLP-main/checkpoint/1008_1308_04_1/model_40_4130.pth')
    model.load_state_dict(checkpoint)
    model.eval()

    output_dir = "/media/main/HDD/yo/GraphMLP-main/output_ViTPose_test9"
