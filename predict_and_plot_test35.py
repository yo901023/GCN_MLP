...
def main():
    ...
    checkpoint = torch.load('/media/main/HDD/yo/GraphMLP-main/checkpoint/0204_2033_58_1/model_19_4598.pth')
    model.load_state_dict(checkpoint)
    model.eval()

    dataset_root_base = "/media/main/HDD/yo/dataset"
    output_base = "/media/main/HDD/yo/GraphMLP-main/output_ViTPose_test35"
