...
def main():
    ...
    checkpoint = torch.load('/media/main/HDD/yo/GraphMLP-main/checkpoint/1129_1817_32_1/model_35_3691.pth')
    model.load_state_dict(checkpoint)
    model.eval()

    output_dir = "/media/main/HDD/yo/GraphMLP-main/output_ViTPose_test22"
