...
def main():
    ...
    model = Model(args, pca_path="pca_24300_to_512_50000.npz").cuda()
    checkpoint = torch.load('/media/main/HDD/yo/GraphMLP-main/checkpoint/0107_2154_55_1/model_38_3349.pth')
    model.load_state_dict(checkpoint)
    model.eval()

    output_dir = "/media/main/HDD/yo/GraphMLP-main/output_ViTPose_test29"
